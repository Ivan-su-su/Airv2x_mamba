...
from opencood.utils.airv2x_utils import get_ex_intrinsic, parse_seq, filter_objects
...
class BaseDataset(Dataset):
    ...
    def __init__(self, params, visualize, train=True):
        ...
        if self.train:
            root_dir = params["root_dir"]  # dataset/airv2x/<seq>
        else:
    ...
    def collate_batch_train(self, batch):
        ...
        label_torch_dict = self.post_processor.collate_batch_airv2x(label_dict_list)
...
if __name__ == "__main__":
    params = load_yaml("/code/opencood/hypes_yaml/airv2x/airv2x_early.yaml")
    airv2x_database = BaseDataset(params, None)
    airv2x_database.retrieve_base_data(5)
